...
This command performs a **complete release** including:

1. **Version bump** in `Cargo.toml`
2. **Changelog update** with release notes
3. **Git tag** creation (`vX.Y.Z`)
4. **GitHub Release** with binaries for macOS (Intel + ARM) and Linux
5. **Homebrew tap auto-update** via GitHub Actions
...
5. **Build** (`cargo build --release`) to verify everything compiles

6. **Commit**: `chore: bump version to X.Y.Z, update changelog`
   - Stage: `Cargo.toml`, `CHANGELOG.md`, and any other modified files
